    ...
    function processRefSugar(decl, statement) {
        ...
        if (callee === $REF) {
            ...
            if (decl.id.type !== 'Identifier') {
                error(`${$REF}() bindings cannot be used with destructuring. ` +
            ...
            if (decl.id.type !== 'Identifier') {
                error(`${$COMPUTED}() bindings cannot be used with destructuring.`, decl.id);
            }
            registerRefBinding(decl.id);
            ...
            if (!decl.id.type.endsWith('Pattern')) {
                error(`${$FROM_REFS}() declaration must be used with destructure patterns.`, decl);
            }
